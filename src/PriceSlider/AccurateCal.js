 ...
 * @returns boolean 
 */
export const isInteger = (val) => Math.floor(val) === val
...
export const add = (a, b, ...args) => {  
  ...
  return args.length ? add(result / tmax, args.shift(), ...args) : (result / tmax)
}
 ...
 * @returns 
 */
export const average = (...args) => div(add(...args), args.length);
